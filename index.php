...
<h4 class="mb-2"><strong><marquee behavior="scroll" scrollamount="12" style="font-size: 1.8em;color: #ff0000;">𝕎 𝔸 𝔹 𝕆 𝕌 𝕊 𝕂 𝔹 𝔸 𝕊 𝔼 𝔻&emsp;     𝕎 𝔸 𝔹 𝕆 𝕌 𝕊 𝕂 𝔹 𝔸 𝕊 𝔼 𝔻 </marquee></strong></h4>
...
LIMIT: <span class="badge badge-secondary"> 10,000</span><br>
...
@keyframes rainbow_animation {
  ...
  <div class="content-body">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><span class="badge badge-dark rainbow_text_animated "><strong>𝙒𝙖𝙗𝙤𝙪 [𝙈𝙤𝙙𝙞𝙛𝙞𝙚𝙙]</strong></span></h4>
    ...
    <option </option>
				...
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="CCN.php">𝘾𝘾𝙉 𝘾𝙃𝘼𝙍𝙂𝙀: $1</option>
               ...
               <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/CCN1.php">𝘾𝘾𝙉 𝘾𝙃𝘼𝙍𝙂𝙀: €1</option> 
...
<div class="col-md-12">
  <div class="card mb-2">
  	<div class="card-body">
<center>
<button class="btn btn-glow btn-bg-gradient-x-blue-cyan text-white" onclick="window.open('https://t.me/Wab0u')" style="width: 100%;">START THE BOT</button>
                                <hr>
...
position: relative;
                            ...
                            <h4 class="text-center"><strong class= "badge badge-dark rainbow_text_animated ">TOOLS</strong></h4>
                                <hr>
                                <h5>SK CHECKER :<span class="badge badge-primary float-right btn-bg-gradient-x-blue-cyan btn-primary"><a href="skchecker/index.php">CLICK</a></span></h5>
                                <hr>
                                <h5>CCGEN :<span class="badge badge-primary float-right btn-bg-gradient-x-blue-cyan btn-primary"><a href="gate/generator.html" target="_blank">CLICK</a></span></h5>
                                <hr>
                                                               <h5>AUTH TIKOL :<span class="badge badge-primary float-right btn-bg-gradient-x-blue-cyan btn-primary"><a href="k/index.php" target="_blank">CLICK</a></span></h5>
...
<footer>
  <p> <b><div class=text-danger> 𝙈𝙤𝙙𝙞𝙛𝙞𝙚𝙙 By <a href="https://t.me/Wab0u">𝙒𝙖𝙗𝙤𝙪</b></a></div></p>
</footer>
<style>
